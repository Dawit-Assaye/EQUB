...
const equbJoinRequestSchema = new Schema({
    ...
    equb_id:{ type: mongoose.Schema.Types.ObjectId,ref:'Equb', required: true },
    request_status:{type:String,required:true,default:"Pending"}
});
module.exports=mongoose.model('EqubJoinRequest',equbJoinRequestSchema)